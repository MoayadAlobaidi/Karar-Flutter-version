/**
 * RecordAuditEventAuditTrail — this module's AuditTrail port wired to the
 * audit module's RecordAuditEvent use case (via @karar/audit's public API),
 * so every entry passes the audit metadata guard. The composition root
 * constructs the use case (writer + id source) and hands it here.
 */
