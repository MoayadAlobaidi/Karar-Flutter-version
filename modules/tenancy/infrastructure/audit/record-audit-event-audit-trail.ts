/**
 * RecordAuditEventAuditTrail — the tenancy AuditTrail port wired to the audit
 * module's RecordAuditEvent use case (via @karar/audit's public API), so every
 * entry passes the audit metadata guard.
 */
