/**
 * UUID v7 identity for this module's rows (data-model.md §2: time-ordered
 * primary keys). Randomness and the clock live here, behind the IdSource
 * port. Layout per RFC 9562 §5.7 — same construction as the audit module's
 * id source, reimplemented locally because infrastructure implementations
 * are never imported across modules (clean-architecture.md §4).
 */
