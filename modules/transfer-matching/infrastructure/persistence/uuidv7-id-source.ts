 ...
 * already say. Note what a v7 id does NOT leak here: it says when a match was
 * SUGGESTED, which `first_suggested_at` says anyway, and nothing whatever
 * about the two movements it relates.
 */
