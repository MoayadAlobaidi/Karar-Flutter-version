...
| **3** | Identity, users, tenancy, **operating-entity**, RBAC, consent + **re-consent evaluation**, sessions, kill switches, **PostgreSQL RLS**, adversarial cross-tenant tests — **in progress** ([report](phases/phase-03.md)) | **RLS here**, +entity, +re-consent |
