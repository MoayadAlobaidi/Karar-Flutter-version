...
| **5** | Financial data platform — institutions, connectors, accounts, transactions, normalization, dedup, provenance, categorization; **manual + CSV `IMPLEMENTED`**; **erasure strategies enforced** — **IN PROGRESS** ([report](phases/phase-05.md)); nothing built yet, the phase has just opened | +erasure |
