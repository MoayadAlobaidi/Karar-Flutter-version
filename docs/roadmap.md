...
| **4** | Flutter foundation — bootstrap, routing, design system, **Arabic RTL first-class**, network, auth, secure storage, biometric lock, capability-aware navigation — **in progress** ([report](phases/phase-04.md)) | |
