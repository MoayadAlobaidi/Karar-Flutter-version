...
The skipped Flutter test and the skipped mobile-security test are the same class: an assertion that needs an artifact or a device the running lane does not have. The four skipped architecture tests are deferred by activation phase, not by failure — they turn on at phases 5 and 13.
