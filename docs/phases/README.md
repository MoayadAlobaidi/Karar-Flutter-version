...
| [`phase-05.md`](phase-05.md) | 5 — Financial data platform: institutions, connectors, accounts, transactions, normalization, dedup, provenance, categorization; manual and CSV ingestion; erasure strategies enforced | **IN PROGRESS — data foundation only, reachable by nothing; manual entry, CSV and categorization not built; retention unresolved** |
