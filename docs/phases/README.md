...
| [`phase-04.md`](phase-04.md) | 4 — Flutter and mobile security foundation: app architecture, authentication and session UX, tenant selection, capability-aware navigation, Arabic RTL, accessibility, mobile security |
