...
**Numbering is continuous, 0001–0028.** The data-lifecycle ADR was numbered 0027 when raised in Phase 0 (0026 was briefly reserved for subject-elected policy, which was instead folded into [0015](0015-policy-packs.md) per the one-rule-per-decision principle); the Phase 0.5 consolidation renumbered it to 0026.
